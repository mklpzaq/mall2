				...
				<div class="col-md-8">
					...
					<form class="form-horizontal" action="${pageContext.request.contextPath}/updateItemForm" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="inputItemName" value="${itemForm.itemName}" name="ItemName">
							</div>
						</div>	
						<div class="form-group">
							<label for="inputItemPrice" class="col-sm-2 control-label">상품가격</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="inputItemPrice" value="${itemForm.itemPrice}" name="ItemPrice">
							</div>
						</div>				
						<div class="form-group">
